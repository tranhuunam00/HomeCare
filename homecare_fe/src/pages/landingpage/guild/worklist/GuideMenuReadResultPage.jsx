    ...
    <>
      ...
      <div className={styles.container}>
        ...
        <ul>
          ...
          <li>
            <Tag color="blue">Chưa đọc</Tag> – Đã tiếp nhận nhưng chưa bắt đầu
            đọc kết quả.
          </li>
          <li>
            <Tag color="processing">Đang đọc</Tag> – Bác sĩ đang nhập nội dung
            kết quả.
          </li>
          <li>
          ...
          <li>
            <Tag color="success">Đã duyệt</Tag> – Kết quả đã được phê duyệt
            chính thức.
          </li>
        </ul>
        ...
        <Paragraph>
          ...
          chuyển trạng thái sang <Tag color="processing">Đang đọc</Tag> và khóa
          ca bệnh với các tài khoản khác.
        </Paragraph>

        <Paragraph>
          Nếu muốn bác sĩ khác tiếp tục đọc, cần thực hiện{" "}
          <Tag color="red">Hủy đọc</Tag> để đưa ca bệnh về trạng thái ban đầu,
          sau đó bác sĩ khác mới có thể nhận đọc.
        </Paragraph>
        <Divider />
        ...
        <Collapse accordion>
          <Panel header="Khi nào được phép duyệt kết quả?" key="1">
            <p>
              ...
              công, và tài khoản có quyền duyệt, hệ thống mới cho phép chuyển
              sang trạng thái <Tag color="success">Đã duyệt</Tag>.
            </p>
            <p>
              Nếu chưa lưu, nút duyệt sẽ không hoạt động hoặc hệ thống sẽ yêu
              cầu lưu trước.
            </p>
          </Panel>
          ...
          <Panel header="Có thể chỉnh sửa sau khi duyệt không?" key="2">
            ...
            <p>
              ...
              <Tag color="red">Hủy duyệt</Tag> để đưa ca bệnh về trạng thái
              trước đó và tiếp tục chỉnh sửa.
            </p>
          </Panel>
