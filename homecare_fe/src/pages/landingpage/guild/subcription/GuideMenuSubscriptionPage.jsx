  ...
  return (
    <>
      ...
      <div className={styles.container}>
        ...
        <ul>
          <li>
            Xem danh sách các gói dịch vụ của D-RADS (BASIC, PRO, HOSPITAL)
          </li>
        ...
        <ul>
          ...
          <li>
            <strong>HOSPITAL</strong> – Dành cho phòng khám / bệnh viện với đầy
            đủ quyền quản lý và phân quyền
          </li>
        </ul>
        ...
        <Collapse accordion>
          ...
          <Panel header="Hết hạn thì sao?" key="3">
            <p>
              Khi gói hết hạn, các quyền nâng cao sẽ bị khóa và hệ thống sẽ
              chuyển về quyền mặc định của gói cơ bản.
            </p>
          </Panel>
