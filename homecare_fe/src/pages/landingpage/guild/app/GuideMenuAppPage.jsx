  ...
  return (
    <>
      ...
      <div className={styles.container}>
        ...
        <Paragraph>
          Menu <strong>Ứng dụng</strong> cho phép người dùng truy cập các công
          cụ đánh giá như:
        </Paragraph>

        <ul>
          <li>
            D-RECIST – Đánh giá đáp ứng điều trị theo tiêu chuẩn RECIST 1.1
          </li>
        ...
        <Collapse accordion>
          ...
          <Panel header="Có tự động lưu kết quả không?" key="3">
            <p>
              Sau khi nhấn nút Kết quả, hệ thống sẽ không lưu trạng thái đánh
              giá và hiển thị trong danh sách bệnh nhân.
            </p>
          </Panel>
        </Collapse>
      </div>
